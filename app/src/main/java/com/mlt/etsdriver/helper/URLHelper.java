...
//    change to mlt New Domain.-----> "https://ets.mltcorporate.com/"
    String BASE = "https://ets.mltcorporate.com";



//    Old one is below
//    String BASE = "https://mltweb.mltcorporatesolutions.com/";


    String STRIPE_TOKEN = "pk_test_51LMx3pIODijmwUMNSu1K6qC1g0nllUjw4GSQAThd4Xqmq3XPqalrtmnqE3d1VR8E1K6iM1j7jMi8RRJ55uZh0t9N00utpucrAl";
    ...
    String login = BASE + "api/driver-login";
    String register = BASE + "api/driver-registration";// for new domain.
